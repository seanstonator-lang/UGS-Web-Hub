...
export const failure = fs.readFileSync(path.join(baseDir, "Checkfailed.html"), "utf8")
export const placeholder = fs.readFileSync(path.join(baseDir, "placeholder.svg"), "utf8")
...
export async function MasqFail(req, reply) {
  ...
  const safeJoin = path.join(baseDir, "Masqrd", safeSuffix)
