...
const port = Number(process.env.PORT || process.env.DOGEUB_PORT || 2345), server = createServer(), bare = createBareServer("/seal/");
...
app.listen({ host: "127.0.0.1", port }).then(()=>console.log(`UGS DogeUB running on http://127.0.0.1:${port}`));
